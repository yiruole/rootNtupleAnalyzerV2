...
float & Muon::Pt                      (){ return m_collection -> GetData() -> MuonPt                         -> at ( m_raw_index ); } 
float & Muon::PtError                 (){ return m_collection -> GetData() -> MuonPtError                    -> at ( m_raw_index ); } 
float & Muon::Eta                     (){ return m_collection -> GetData() -> MuonEta                        -> at ( m_raw_index ); } 
float & Muon::Phi                     (){ return m_collection -> GetData() -> MuonPhi                        -> at ( m_raw_index ); } 

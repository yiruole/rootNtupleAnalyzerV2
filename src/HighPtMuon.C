...
float & HighPtMuon::Pt                      (){ return (m_isGlobal ? m_collection -> GetData() -> MuonCocktailPt      -> at ( m_raw_index_alternate ) : m_collection -> GetData() -> MuonPt      -> at ( m_raw_index ) ); } // OK
float & HighPtMuon::Eta                     (){ return (m_isGlobal ? m_collection -> GetData() -> MuonCocktailEta     -> at ( m_raw_index_alternate ) : m_collection -> GetData() -> MuonEta     -> at ( m_raw_index ) ); } // OK
float & HighPtMuon::Phi                     (){ return (m_isGlobal ? m_collection -> GetData() -> MuonCocktailPhi     -> at ( m_raw_index_alternate ) : m_collection -> GetData() -> MuonPhi     -> at ( m_raw_index ) ); } // OK
float   HighPtMuon::Charge                  (){ return (m_isGlobal ? m_collection -> GetData() -> MuonCocktailCharge  -> at ( m_raw_index_alternate ) : m_collection -> GetData() -> MuonCharge  -> at ( m_raw_index ) ); } // OK
float   HighPtMuon::PtError                 (){ return (m_isGlobal ? m_collection -> GetData() -> MuonCocktailPtError -> at ( m_raw_index_alternate ) : m_collection -> GetData() -> MuonPtError -> at ( m_raw_index ) ); } // OK
...
float HighPtMuon::GlobalChi2                (){ return m_collection -> GetData() -> MuonCocktailGlobalChi2         -> at ( m_raw_index ); } // OK
...
float HighPtMuon::BestTrackVtxDistXY        (){ return m_collection -> GetData() -> MuonBestTrackVtxDistXY         -> at ( m_raw_index ); } // No change (but wrong?)
float HighPtMuon::BestTrackVtxDistZ         (){ return m_collection -> GetData() -> MuonBestTrackVtxDistZ          -> at ( m_raw_index ); } // No change (but wrong?)

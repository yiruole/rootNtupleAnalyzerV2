...
if [ "$YEAR" = "2016" ]; then
  ...
  #INPUTLIST=config/nanoV7_2016_rskSingleEleL_egLoose_31jan2022/inputListAllCurrent.txt
  INPUTLIST=config/nanoV7_2016_rskSingleEleL_egLoose_3feb2022/inputListAllCurrent.txt
  SKIMNAME=pskEEJJ_egLoose_4feb2022

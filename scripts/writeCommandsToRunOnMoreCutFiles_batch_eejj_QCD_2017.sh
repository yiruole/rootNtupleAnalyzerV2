...
#------------
INPUTLIST=config/nanoV6_2017_rskQCD_18may2020_comb/inputList_dataOnly.txt
#INPUTLIST=config/nanoV6_2017_rskQCD_18may2020_comb/inputListAllCurrent.txt
#INPUTLIST=config/nanoV6_2017_pskEEJJ_8may2020_comb/inputListAllCurrent.txt
...
COMMANDFILE=commandsToRunOnMoreCutFiles_eejj_QCD_2017_batch_`hostname -s`.txt

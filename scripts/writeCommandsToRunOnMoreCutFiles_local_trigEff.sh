...
files="/afs/cern.ch/user/s/scooper/work/private/LQNanoAODAttempt/Leptoquarks/analyzer/rootNtupleMacrosV2/config2016/Studies/SignalEffiTriggerStudy/cutTable_lq1_eejj_trigger1_id1_effiStudy.txt
/afs/cern.ch/user/s/scooper/work/private/LQNanoAODAttempt/Leptoquarks/analyzer/rootNtupleMacrosV2/config2016/Studies/SignalEffiTriggerStudy/cutTable_lq1_eejj_trigger1_id4_effiStudy.txt"


#------------
OUTDIRPATH=$LQDATA/studies/  # a subdir will be created for each cut file 
SUBDIR=idEffStudies2016_2021sep20
...
#------------
ILUM=35867 # integrated luminosity in pb-1 to be used for rescaling/merging MC samples
...
#------------
INPUTLIST=config/nanoV7_2016_postProc/inputList_signalsOnly.txt
...
COMMANDFILE=commandsToRunOnMoreCutFiles_idEff_local_`hostname -s`.txt
echo "" > $COMMANDFILE

...
// Tue Jun 18 16:45:05 2019 by ROOT version 6.16/00
// from TChain Events/
//////////////////////////////////////////////////////////
...
class rootNtupleClass : public TSelector {
public :
   ...
   TTreeReaderArray<Float_t> Electron_caloEnergy = {fReader, "Electron_caloEnergy"};
   ...
   TTreeReaderArray<Float_t> Electron_scEnergy = {fReader, "Electron_scEnergy"};
   TTreeReaderArray<Float_t> Electron_scEta = {fReader, "Electron_scEta"};
   TTreeReaderArray<Float_t> Electron_scPhi = {fReader, "Electron_scPhi"};
   ...
   TTreeReaderArray<Float_t> Electron_trkPx = {fReader, "Electron_trkPx"};
   TTreeReaderArray<Float_t> Electron_trkPy = {fReader, "Electron_trkPy"};
   TTreeReaderArray<Float_t> Electron_trkPz = {fReader, "Electron_trkPz"};
   ...
   TTreeReaderValue<UChar_t> Flag_BadChargedCandidateFilter = {fReader, "Flag_BadChargedCandidateFilter"};
   TTreeReaderValue<UChar_t> Flag_BadGlobalMuon = {fReader, "Flag_BadGlobalMuon"};
   TTreeReaderValue<UChar_t> Flag_BadPFMuonFilter = {fReader, "Flag_BadPFMuonFilter"};
   TTreeReaderValue<UChar_t> Flag_CloneGlobalMuon = {fReader, "Flag_CloneGlobalMuon"};
   ...
   TTreeReaderArray<Float_t> Muon_ptTuneP = {fReader, "Muon_ptTuneP"};

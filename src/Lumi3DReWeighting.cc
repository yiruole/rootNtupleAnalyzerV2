...
Lumi3DReWeighting::Lumi3DReWeighting ( std::string generatedFile, std::string dataFile, std::string GenHistName , std::string DataHistName ) :
  generatedFileName_ ( generatedFile), 
  dataFileName_      ( dataFile ), 
  GenHistName_       ( GenHistName ), 
  DataHistName_      ( DataHistName ) {

TFile * generatedFile_ = new TFile(generatedFileName_.c_str() ); //MC distribution
TFile * dataFile_      = new TFile(dataFileName_.c_str() );      //Data distribution

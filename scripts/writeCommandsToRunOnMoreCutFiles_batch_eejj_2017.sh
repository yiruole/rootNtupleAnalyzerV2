...
#files="/afs/cern.ch/user/s/scooper/work/private/LQNanoAODAttempt/Leptoquarks/analyzer/rootNtupleMacrosV2/config2017/Analysis/cutTable_lq_eejj_noJets.txt"
# opt
...
ANANAME=prefire_22may2020
OUTDIRPATH=$LQDATA  # a subdir will be created for each cut file 
SUBDIR=nanoV6/2017/analysis/$ANANAME
EOSDIR=/eos/user/s/scooper/LQ/NanoV6/2017/analysis/$ANANAME
...
#------------
INPUTLIST=config/nanoV6_2017_pskEEJJ_4jun_25and8may2020_comb/inputList_4jun.txt
...
COMMANDFILE=commandsToRunOnMoreCutFiles_eejj_2017_batch_`hostname -s`.txt

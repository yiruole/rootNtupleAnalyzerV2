...
float & Electron::Pt                 (){ return m_collection->ReadArrayBranch<Float_t>("Electron_pt")  [m_raw_index]; } 
float & Electron::Eta                (){ return m_collection->ReadArrayBranch<Float_t>("Electron_eta") [m_raw_index]; } 
float & Electron::Phi                (){ return m_collection->ReadArrayBranch<Float_t>("Electron_phi") [m_raw_index]; } 

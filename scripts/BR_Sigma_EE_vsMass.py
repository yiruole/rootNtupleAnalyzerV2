...
def BR_Sigma_EE_vsMass():
    ...
    # LQToDEle, parameterized BDT 1000-2000, 2016pre, no QCD
    massPoints = 7
    mData = [1100.0 , 1200.0 , 1300.0 , 1400.0 , 1500.0 , 1600.0 , 1700.0 , ]
    x_shademasses = [1100.0 , 1200.0 , 1300.0 , 1400.0 , 1500.0 , 1600.0 , 1700.0 , 1700.0 , 1600.0 , 1500.0 , 1400.0 , 1300.0 , 1200.0 , 1100.0 , ]
    xsUp_expected = [0.0005518712 , 0.0005530714 , 0.0005187322 , 0.0005006085 , 0.00049349428 , 0.0004874079 , 0.000477210326 , ]
    xsUp_observed = []
    y_1sigma = [0.0004068264 , 0.000413222 , 0.00038758104 , 0.00037407825 , 0.00036999796 , 0.00036543345 , 0.000357792636 , 0.000680739863 , 0.00069334695 , 0.00070395652 , 0.0007121415 , 0.00073992744 , 0.000786737 , 0.0007918152 , ]
    y_2sigma = [0.0003256768 , 0.0003348848 , 0.00031403572 , 0.000303114 , 0.00030072768 , 0.0002970072 , 0.000290799489 , 0.000969632683 , 0.0009922179 , 0.0010027202 , 0.0010127565 , 0.00105067739 , 0.0011152956 , 0.0011277368 , ]
    lint = "19.5 fb^{-1}"
